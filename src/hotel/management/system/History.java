...
public class History extends JFrame{
    ...
    History() {
        ...
        JLabel employeeInformationLabel = new JLabel("Employee History");
        ...
        try {
            ...
            String query = "select * from fired_employee_information";
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == searchButton) {
                ...
                try {
                    ...
                    String query1 = "select * from fired_employee_information";
                    String query2 = "select * from fired_employee_information where name = '"+ name +"'";
                    String query3 = "select * from fired_employee_information where job = '" + job + "'";
                    String query4 = "select * from fired_employee_information where job = '" + job + "' AND name = '" + name + "'";
